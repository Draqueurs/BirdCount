...
class RegionShapeFrame(customtkinter.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.plus_image = customtkinter.CTkImage(
            light_image=Image.open("icons/plus_light.png"),
            dark_image=Image.open("icons/plus_dark.png"),
            size=(20, 20)
        )
        self.minus_image = customtkinter.CTkImage(
            light_image=Image.open("icons/minus_light.png"),
            dark_image=Image.open("icons/minus_dark.png"),
            size=(20, 20)
        )
        self.rectangle_image = customtkinter.CTkImage(
            light_image=Image.open("icons/rectangle_light.png"),
            dark_image=Image.open("icons/rectangle_dark.png"),
            size=(20, 20)
        )
        self.polygon_image = customtkinter.CTkImage(
            light_image=Image.open("icons/polygon_light.png"),
            dark_image=Image.open("icons/polygon_dark.png"),
            size=(20, 20)
        )
        self.rectangle_red_image = customtkinter.CTkImage(
            Image.open("icons/rectangle_red.png"),
            size=(20, 20)
        )
        self.polygon_red_image = customtkinter.CTkImage(
            Image.open("icons/polygon_red.png"),
            size=(20, 20)
        )
        #======================================================================#
        #                                Frames                                #
